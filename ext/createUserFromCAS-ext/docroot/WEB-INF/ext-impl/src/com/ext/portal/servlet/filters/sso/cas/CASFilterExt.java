...
package com.ext.portal.servlet.filters.sso.cas;
 ...
 * @author Zsolt Balogh
 */
public class CASFilterExt extends BasePortalFilter {


    private void _createUserFromCAS(
            long companyId, String login, Assertion assertion)
        throws PortalException, SystemException {

        // I have to build the IFAD user emailAddress using CAS login and
        // company MX

        Company company = CompanyLocalServiceUtil.getCompany(companyId);

        String emailAddress = login + '@' + company.getVirtualHostname();

    	//String emailAddress = (String)assertion.getAttributes().get("emailAddress");
...
//        String firstName = (String)assertion.getAttributes().get("givenName");
//        String lastName = (String)assertion.getAttributes().get("SN");
        ...
        UserLocalServiceUtil.updateReminderQuery(userID, "ccss", "ccss");
