...
<form id="edit_form" name="<portlet:namespace />edit_form" action="<%=editDocument.toString()%>"  enctype="multipart/form-data" method="post">
 ...
 <div class="row">
	...
	<table class="table">
		...
		<tr>
			<td>Source</td>
			<td> <input value="<%=datasetDetails.get("url")%>" id="source"  name="<portlet:namespace />source"/></td>
		</tr>
		<tr>
			<td>License</td>
			<td>
		...
		<tr>
			<td>Author</td>
			<td><input id="author" name="<portlet:namespace />author" value="<%=datasetDetails.get("author")%>"/></td>
		</tr>
		<tr>
			<td>Tags</td>
			<td>
...
<div style="display:none"  class="form-group">                
	...
	<div class="bs-wizard-step" style="margin:0">				
					...
					<a class="btn btn-default" href="/my-datasets">Cancel</a>
	</div>	
</div>
</form>
...
<div class="datasetDetails">
 <div class="row">
 <div class="col-md-12"><h3><%=datasetDetails.get("title")%></h3></div>
 </div>
