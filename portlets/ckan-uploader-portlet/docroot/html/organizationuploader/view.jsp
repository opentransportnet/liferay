...
<portlet:actionURL var="orgDocument" name="orgDocument"></portlet:actionURL>
<% 
...
<liferay-ui:error key="dTankerror" message="<%=dTankerror%>" />
    ...
    <form id="org_form" name="<portlet:namespace />org_form" action="<%=orgDocument.toString()%>"  enctype="multipart/form-data" method="post">
          ...
          <div class="col-md-7">
              	...
              	<div class="form-group" id="linkDiv" style="display:none" >
                	...
                	<label class="registrationLegend"><liferay-ui:message key="link" /></label> 
               		...
               		<div>	
                 		...
                 		<input class="inputText" class="upload-group" type="text" id="link" name="<portlet:namespace />link" >
            	 ...
            	 <div class="form-group">
                	...
                	<label class="registrationLegend"><liferay-ui:message key="license" /></label> 
               		...
               		<div style="padding:0px !important;" >	
                 		...
                 		<select class="inputText" id="license"  class="step_1 validation"  name="<portlet:namespace />license">
				...
				<br/><br/>
					<button class= "btn centralSubmissionButton" type="Submit"><liferay-ui:message key="upload-org-dataset" /></button>
				
              	</div>
              	</div> 
              
					<div class="col-sm-3 col-sm-offset-1 rightNoteRegistration">
					<label class="registrationLegend"><liferay-ui:message key="org-datasets" /></label>
						<br/><br/>
					<label><liferay-ui:message key="see-org-datasets" /></label>
					<br/><br/>
					
					<div style="border-bottom:#fff solid 10px;">
					<a href="/web/<%=city%>/organization-datasets"	class="btn noCapitals centralSeeAllButton" ><liferay-ui:message key="see-all-org-datasets" /></a>
					</div>
					</div>			
