...
/**
 * Portlet implementation class OrganizationUploader
 */
public class OrganizationUploader extends MVCPortlet {
		...
		public void orgDocument(ActionRequest actionRequest,ActionResponse actionResponse) throws IOException,
			...
			try{
				...
				String redirectUrl = actionUrl.toString().replaceAll("upload-organization-dataset", "organization-datasets");
